...
function MdKeyboardProvider() {
    ...
    this.layouts['Hrvatski'] = {
        'name': "Croatian", 'keys': this.layouts['Bosanski'].keys.slice(0), 'lang': ["hr"]
    };
    this.layouts['Sloven\u0161\u010dina'] = {
        'name': "Slovenian", 'keys': this.layouts['Bosanski'].keys.slice(0), 'lang': ["sl"]
    };
    this.layouts['Srpski'] = {
        'name': "Serbian Latin", 'keys': this.layouts['Bosanski'].keys.slice(0), 'lang': ["sr"]
    };
    ...
    // aliases
    this.deadkey['\u00af'] = this.deadkey['-']; // Macron
    this.deadkey['\u00a8'] = this.deadkey['\u309B'] = this.deadkey['"']; // Umlaut / Diaeresis / Greek Dialytika / Hiragana/Katakana Voiced Sound Mark
    this.deadkey['\u00b4'] = this.deadkey['\u0384'] = this.deadkey["'"]; // Acute / Greek Tonos
    this.deadkey['\u00ba'] = this.deadkey['\u00b0']; // Ring
    this.deadkey['\u201a'] = this.deadkey['\u00B8'];
