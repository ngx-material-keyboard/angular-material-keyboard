...
function MdKeyboardProvider() {
    ...
    layouts['\u05d9\u05d9\u05b4\u05d3\u05d9\u05e9'] = { // from http://www.yv.org/uyip/hebyidkbd.txt http://uyip.org/keyboards.html
        'name': "Yiddish", 'keys': [
    ...
    layouts['\u05d9\u05d9\u05b4\u05d3\u05d9\u05e9 \u05dc\u05e2\u05d1\u05d8'] = { // from http://jidysz.net/
    ...
    deadkey['\u02d8'] = { // Romanian and Turkish breve
        'a': "\u0103", 'g': "\u011f",
        'A': "\u0102", 'G': "\u011e"
    };
    ...
    deadkey['\u02dd'] = { // Hungarian Double Acute Accent
        'o': "\u0151", 'u': "\u0171",
        'O': "\u0150", 'U': "\u0170"
    };
    deadkey['\u0385'] = { // Greek Dialytika + Tonos
        '\u03b9': "\u0390", '\u03c5': "\u03b0"
    };
    deadkey['\u00b0'] = deadkey['\u00ba'] = { // Ring
        'a': "\u00e5", 'u': "\u016f",
        'A': "\u00c5", 'U': "\u016e"
    };
    deadkey['\u02DB'] = { // Ogonek
    ...
    deadkey['\u3002'] = { // Hiragana/Katakana Point
        '\u306f': "\u3071", '\u3072': "\u3074", '\u3075': "\u3077", '\u3078': "\u307a", '\u307b': "\u307d",
        '\u30cf': "\u30d1", '\u30d2': "\u30d4", '\u30d5': "\u30d7", '\u30d8': "\u30da", '\u30db': "\u30dd"
    };
