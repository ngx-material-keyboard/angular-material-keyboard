angular
    ...
    .service('mdKeyboardService', ['VKI_CONFIG', function (VKI_CONFIG) {
        /*globals VKI */
        return {
    ...
    .directive('mdKeyboard', ['mdKeyboardService', '$timeout', '$injector',
        function (mdKeyboardService, $timeout, $injector) {
            return {
                restrict: 'A',
                require: '?ngModel',
                scope: {
                ...
                link: function (scope, elements, attrs, ngModelCtrl) {
                    ...
                    mdKeyboardService.attach(elements[0], scope.config, function () {
                        $timeout(function () {
